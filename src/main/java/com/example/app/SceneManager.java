...
public class SceneManager {
    ...
    public static void loadMain()     { loadScene("main", true); }
    public static void loadLogin()    { loadScene("login", true); }
    public static void loadRegister() { loadScene("register", true); }
    public static void loadProfile()  { loadScene("profile", true); }
    public static void loadHome()     { loadScene("home", true); }
